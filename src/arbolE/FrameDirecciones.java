 ...
 * @author omar
 */
public class FrameDirecciones extends javax.swing.JFrame {
...
private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrameDirecciones.class.getName());
...
//crear
  ...
  paginaActual = (paginaActual == 0)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrameDirecciones().setVisible(true));
    }
