...
public class FramePrincipal extends javax.swing.JFrame {
    ...
    jLabel3.setIcon(new ImageIcon(imagenEscalada2));
    }
    ...
    private void initComponents() {
        ...
        jButton10.setText("Arbol Expresion");
        jButton10.addActionListener(this::jButton10ActionPerformed);

        jButton11.setText("Tripletas");

        jButton12.setText("Optimizacion");

        jButton13.setText("Regla Semantica");

        jButton14.setText("Cuadruplos");

        jButton15.setText("Validacion Metodos");

        jButton16.setText("Codigo Intermedio");

        jButton17.setText("N polaca");

        jButton18.setText("Estructura Control");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arbolE/Logo tec.png"))); // NOI18N
        jLabel2.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        jLabel2.setAutoscrolls(true);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arbolE/Logo tec2.png"))); // NOI18N
